...
public class CinemachineCameraShaker : MonoBehaviour
{
	...
	/// The default duration that will be applied to your shakes if you don't specify one
	...
	protected virtual void Awake () 
	{
		...
		_perlin = _virtualCamera.GetComponentInChildren<Cinemachine.CinemachineBasicMultiChannelPerlin> ();
	...
	{
		StartCoroutine (ShakeCameraCo (DefaultDuration, DefaultShakeAmplitude, DefaultShakeFrequency));
	}
