...
public static class UbhUtil
{
    ...
    /// </summary>
    public static float GetAngleFromTwoPositionNoAxis(Transform fromTrans, Transform toTrans)
    {
        Vector3 targetDir = toTrans.position - fromTrans.position;
        return Vector3.Angle(targetDir, fromTrans.forward);
    }
