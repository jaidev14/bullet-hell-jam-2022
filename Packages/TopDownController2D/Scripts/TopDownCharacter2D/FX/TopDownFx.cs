    ...
    public class TopDownFx : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (_controller != null)
            {
                ...
                TryAddListener(_controller.OnDashEvent, TriggerEvents.Dash);
        ...
        private void TryAddListener(object evt, TriggerEvents evtTrigger)
        {
            ...
            switch (evtTrigger)
            {
                case TriggerEvents.Attack:
                    ...
                    {
                        TriggerEffects(evtTrigger, arg0, null);
                    });
                    break;
                case TriggerEvents.Dash:
                    ((UnityEvent<DashConfig>) evt).AddListener(delegate(DashConfig arg0)
                    {
                        TriggerEffects(evtTrigger, null, arg0);
                    });
                    break;
